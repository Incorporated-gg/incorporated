...
exports.getBuildingDestroyedProfit = exports.calcBuildingMaxMoney = exports.calcBuildingResistance = exports.calcBuildingDailyIncome = exports.calcBuildingPrice = exports.buildingsList = void 0;
...
function calcBuildingPrice(buildingID, currentAmount) {
    const buildingInfo = exports.buildingsList.find(b => b.id === buildingID);
    if (!buildingInfo)
        throw new Error(`Building ${buildingID} not found`);
    const priceMultiplier = 0.5 * currentAmount * (currentAmount + 1);
    const price = buildingInfo.basePrice + (0.05 / buildingInfo.maximumDestroyedBuildings) * buildingInfo.basePrice * priceMultiplier;
    return Math.round(price);
}
exports.calcBuildingPrice = calcBuildingPrice;
...
exports.calcBuildingDailyIncome = calcBuildingDailyIncome;
...
exports.calcBuildingResistance = calcBuildingResistance;
const BANK_UNSAFE_THRESHHOLD = 0.4;
function calcBuildingMaxMoney({ buildingID, buildingAmount, bankResearchLevel }) {
    const buildingInfo = exports.buildingsList.find(b => b.id === buildingID);
    if (buildingAmount < 1)
        buildingAmount = 1;
    const maxTotalPer = 800 / buildingInfo.maximumDestroyedBuildings +
...
exports.calcBuildingMaxMoney = calcBuildingMaxMoney;
...
exports.getBuildingDestroyedProfit = getBuildingDestroyedProfit;
